...
local Settings = {
    ...
    BaseBarrelSlot = game:GetService("Workspace").Tycoon.Tycoons[LocalPlayer.leaderstats.Team.Value]["Essentials"][
        "Oil Collector"
    ]["Collector"].BarrelSlot.CFrame,
    BaseDiamondPlate = game:GetService("Workspace").Tycoon.Tycoons[LocalPlayer.leaderstats.Team.Value]["Essentials"][
        "Oil Collector"
    ]["Crate Collector"].DiamondPlate.CFrame
}
        ...
        if Settings.Toggle.InfiniteAmmo then
            for _, v in pairs(LocalPlayer.Backpack:GetChildren()) do
                ...
                if (v.ClassName == "Tool") then
                    v.ACS_Modulo.Variaveis.Ammo.Value = 
...
OtherTab:CreateLabel({text = "before you activate you must make a hit with the weapon"})
...
OtherTab:CreateToggle(
    {
        ...
        callback = function(t)
            if t then
                Workspace.Tycoon.Tycoons[LocalPlayer.leaderstats.Team.Value].Essentials.CashCollector.Cash.Volume = 0
            else
                Workspace.Tycoon.Tycoons[LocalPlayer.leaderstats.Team.Value].Essentials.CashCollector.Cash.Volume = 0.4
            end
        end
    }
)
...
TeleportTab:CreateLabel({text = "Oil Barrels Farm"})
...
TeleportTab:CreateLabel({text = "Crates Farm"})
            ...
            for _, v in pairs(game:GetService("Workspace")["Game Systems"]["Crate Workspace"]:GetChildren()) do
                if (v.Name:find("Tank") or v.Name:find("Tank Crate")) then
                    LocalPlayer.Character.HumanoidRootPart.CFrame =
                        game:GetService("Workspace")["Game Systems"]["Crate Workspace"][v.Name].CFrame
                    break
                end
            end
        end
...
TeleportTab:CreateLabel({text = "AirDrop Farm"})
...
TeleportTab:CreateLabel({text = "you can teleport only to the loaded bases"})
...
mt.__namecall = newcclosure(function(self, ...)
    local args = {...}
    if self == "ClaimBase" and getnamecallmethod() == "FireServer" or getnamecallmethod() == "InvokeServer" or getnamecallmethod() == "Invoke" or getnamecallmethod() == "Fire" and _G.Waitclaimbase == true then
        _G.Waitclaimbase = false
